...
async function findAccessiblePaperRolls() {
    ...
    let paperRollsCountChanged = true;
    while(paperRollsCountChanged) {
        const removedRolls = [];
        ...
        removedRolls.forEach(roll => {
           paperGrid[roll[0]][roll[1]] = ".";
        });
        paperRollsCountChanged = !(removedRolls.length === 0);
    }
